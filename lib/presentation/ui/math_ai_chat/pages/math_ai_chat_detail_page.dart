...
class MathAiChatDetailPage extends StatefulWidget {
  final int? mathAiId;

  const MathAiChatDetailPage({super.key, this.mathAiId});

  @override
  State<MathAiChatDetailPage> createState() => _MathAiChatPageState();
}

class _MathAiChatPageState extends State<MathAiChatDetailPage>
    ...
    return GestureDetector(
      onTap: () {
        ...
        if (assetPath == "assets/icons/ic_copy.svg") {
          if (lastUserMessage.content != null && lastUserMessage.content!.isNotEmpty) {
            Clipboard.setData(ClipboardData(text: lastUserMessage.content!));
